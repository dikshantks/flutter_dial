...
import 'src/dial_config_provider.dart';
...
class RotationDialInput extends StatefulWidget {
  const RotationDialInput({
    ...
    this.passcodeAnimationInProgress = false,
    ...
    this.textStyle = const TextStyle(
        fontSize: 20.0, color: Colors.white), // Default text style
    ...
    return DialConfigProvider(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final numDistFromCenter = widget.boxSize / 2 -
              config.singleNumberRadius -
              config.singleNumberPadding;
          return Stack(
